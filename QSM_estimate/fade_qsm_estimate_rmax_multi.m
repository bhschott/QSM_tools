function err_subs = fade_qsm_estimate_rmax_multi(volname, scanner_name, lambda)
...
if nargin < 3
    lambda = 39;  % floor(10^1.6), suggested by Acosta-Cabronero et al., 2018
end
