function spm_skull_strip(anat_path, tp_thr, prefix)
% _
...
%
% edited by Bjoern Schott 07/2024
% E-Mail: bjoern-hendrik.schott@dzne.de
...
anat_hdr.fname   = strcat(work_dir,'/',prefix,anat_name,img_ext);
